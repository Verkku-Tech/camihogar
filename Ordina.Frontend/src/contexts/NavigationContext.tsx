...
export const defaultNavigationItems: NavigationItem[] = [
  ...
  {
    id: "existencias",
    name: "Existencias Inmediatas",
    href: "/inventario/existencias",
    category: "inventory",
    active: true,
    description: "Consulta y reserva de existencias físicas multisede",
    superAdminOnly: false,
    allowedRoles: [],
  },
  {
    id: "transferencias",
    name: "Traspasos entre Sedes",
    href: "/inventario/transferencias",
    category: "inventory",
    active: true,
    description: "Movimientos y traslados de mercancía entre tiendas y almacenes",
    superAdminOnly: false,
    allowedRoles: [],
  },
  {
    ...
    category: "inventory",
    active: true,
    description: "Gestión de almacenes y depósitos centrales",
    superAdminOnly: false,
    allowedRoles: [],
  },
  {
