        ...
        <div className="flex items-center justify-between flex-wrap gap-2">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground">Ranking por volumen de unidades y facturación generada</p>
            </div>
          </div>
          {data.length > 0 && (
                ...
                {data.map((p, i) => {
                  ...
                  return (
                    <tr key={i} className="hover:bg-muted/30 transition-colors group">
                      ...
                      <td className="py-3 px-4 font-semibold text-foreground group-hover:text-primary transition-colors max-w-[260px] truncate">
                        {p.productName}
                      </td>
