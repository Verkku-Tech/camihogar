...
builder.Services.AddSwaggerGen(c =>
{
    ...
    {
        Title = "Ordina Providers API",
        Version = "v1",
        Description = "API para la gestión de proveedores y productos en el sistema Ordina"
    });
});
...
app.UseSwaggerUI(c =>
{
    c.SwaggerEndpoint("/swagger/v1/swagger.json", "Ordina Providers API v1");
