...
public interface IOrderCoreService
{
    ...
    Task<OrderResponseDto?> GetByIdAsync(string id, bool includeImages, CancellationToken cancellationToken = default);
    Task<OrderResponseDto?> GetByOrderNumberAsync(string orderNumber, CancellationToken cancellationToken = default);
    Task<OrderResponseDto?> GetByOrderNumberAsync(string orderNumber, bool includeImages, CancellationToken cancellationToken = default);
